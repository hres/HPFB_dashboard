...
med_device_ncr<-read.xlsx('data/Operational Dashboard - med device data.xlsx',sheet=2,rows=c(3:12),colNames=T,fillMergedCells = TRUE)

tpd<-read.xlsx('data/Operational Dashboard - pharma rx data.xlsx',sheet=1,rows=c(3:11),colNames=T)
tpd_ncr<-read.xlsx('data/Operational Dashboard - pharma rx data.xlsx',sheet=1,rows=c(3:15),colNames=T)
